...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Match>(entity =>
        {
            ...
            entity.HasMany(d => d.FkTeamidTeams).WithMany(p => p.FkMatchidMatches)
                .UsingEntity<Dictionary<string, object>>(
                    "Participate",
                    r => r.HasOne<Team>().WithMany()
                        .HasForeignKey("FkTeamidTeam")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("fk_participates_team"),
                    l => l.HasOne<Match>().WithMany()
                        .HasForeignKey("FkMatchidMatch")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("fk_participates_match"),
                    j =>
                    {
                        j.HasKey("FkMatchidMatch", "FkTeamidTeam").HasName("participates_pkey");
                        j.ToTable("participates");
                        j.IndexerProperty<int>("FkMatchidMatch").HasColumnName("fk_matchid_match");
                        j.IndexerProperty<int>("FkTeamidTeam").HasColumnName("fk_teamid_team");
                    });
        });
        ...
        modelBuilder.Entity<Payouttransaction>(entity =>
        {
            ...
            entity.HasIndex(e => e.FkBetidBet, "payouttransaction_fk_betid_bet_key").IsUnique();
        ...
        modelBuilder.Entity<Wager>(entity =>
        {
            ...
            entity.HasIndex(e => e.FkMatchidMatch, "wager_fk_matchid_match_key").IsUnique();
